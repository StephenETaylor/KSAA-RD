...
def transform_with_dictionary(src, trg, t_dict):
    """
    Transforms the embeddings with a given dictionary

    :param src: source embeddings
    :param trg: target embeddings
    :param t_dict:  transform dict
    :return: transformation matrix
    """


    # build translation arrays:
    X, Y = build_dict(t_dict, src, trg)
...
def ensure_get_index(KVmodel):
    """
        ...
        Returned value should be stored to prevent trf from garbage collection
    """
